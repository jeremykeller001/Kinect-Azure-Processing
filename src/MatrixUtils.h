...
private:
	...
	static Eigen::RowVector4d convertRowVector3To4(Eigen::RowVector3d coordinate3);

	static Eigen::RowVector3d convertRowVector4To3(Eigen::RowVector4d coordinate4);
